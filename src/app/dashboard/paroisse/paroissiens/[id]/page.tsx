...
import { ArrowLeft, Edit, Trash, Mail, Phone, MapPin, Calendar, Users, Heart, Clock, Plus } from "lucide-react";
  ...
  const paroissiens = [
    {
      ...
      sacrements: [
        ...
        { type: "Confirmation", date: "15/09/1990", lieu: "Cathédrale Notre-Dame" },
        { type: "Mariage", date: "08/07/2000", lieu: "Église Saint-Joseph", conjoint: "Marie Durant" },
      ],
      dons: [
      ...
      notes: "Participe régulièrement aux activités paroissiales. Disponible pour les lectures durant les messes dominicales. A exprimé son intérêt pour rejoindre l'équipe d'animation liturgique."
    },
    {
      id: "2",
      nom: "Martin",
      ...
      sacrements: [
        ...
        { type: "Confirmation", date: "20/06/1998", lieu: "Cathédrale Notre-Dame" },
      ],
      dons: [
        { date: "05/01/2025", montant: "100 €", type: "Denier de l'Église" },
        { date: "20/04/2025", montant: "20 €", type: "Offrande de messe" },
      ],
      notes: "Très impliquée dans la catéchèse des enfants. Membre de la chorale paroissiale depuis 2015. A proposé d'organiser un événement pour les familles à Noël."
    }
  ];
...
export default function ParoissienDetailPage({ params }: ParoissienDetailPageProps) {
  const paroissien = getParoissien(params.id);

  if (!paroissien) {
    return (
      <div className="text-center py-12">
        <h1 className="text-2xl font-bold text-slate-900 mb-4">Paroissien non trouvé</h1>
        <p className="text-slate-600 mb-6">Le paroissien que vous recherchez n'existe pas.</p>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <Badge variant={paroissien.statut === 'actif' ? 'success' : 'secondary'}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p>{paroissien.prenom} {paroissien.nom}</p>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="flex items-center">
                    ...
                    <a href={`mailto:${paroissien.email}`} className="text-blue-600 hover:underline">
                      {paroissien.email}
                    </a>
                  </p>
                </div>
                <div className="space-y-1">
                  ...
                  <p className="flex items-center">
                    ...
                    <a href={`tel:${paroissien.telephone}`} className="text-blue-600 hover:underline">
                  ...
                  >
                    <div className="flex items-center mb-2 sm:mb-0">
                      ...
                      <div>
                        ...
                        {sacrement.conjoint && (
                          <p className="text-sm text-slate-500">avec {sacrement.conjoint}</p>
                        )}
                      </div>
                    </div>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b border-slate-200">
                      <th className="py-2 px-4 text-left text-sm font-medium text-slate-500">Date</th>
                      <th className="py-2 px-4 text-left text-sm font-medium text-slate-500">Type</th>
                      <th className="py-2 px-4 text-right text-sm font-medium text-slate-500">Montant</th>
                    </tr>
                  </thead>
                  <tbody>
                    {paroissien.dons.map((don, index) => (
                      <tr key={index} className="border-b border-slate-100">
                        ...
                        <td className="py-2 px-4 text-right font-medium text-slate-900">{don.montant}</td>
                      </tr>
                    ))}
                  ...
                  {paroissien.dons.length > 0 && (
                    <tfoot>
                      <tr>
                        <td colSpan={2} className="py-2 px-4 text-right font-medium text-slate-700">Total</td>
                        <td className="py-2 px-4 text-right font-bold text-slate-900">
                          {paroissien.dons.reduce((total, don) => {
                            const montant = parseFloat(don.montant.replace(/[^0-9,.-]/g, '').replace(',', '.'));
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Invitation à la fête paroissiale</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">Présence à l'événement</p>
                    <p className="text-xs text-slate-500">Messe du dimanche</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Réunion du conseil pastoral</p>
                    <p className="text-xs text-slate-400 mt-1">Il y a 2 semaines</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-slate-700">{paroissien.notes}</p>
